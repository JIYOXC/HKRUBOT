    ...
    def emit(self, record):
        for X in ["OSError", "TimeoutError"]:
            if X in record.getMessage():
                os.system(f"kill -9 {os.getpid()} && python3 -m miko")
...
class Ubot(Client):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs, device_model="ʜɪᴋᴀʀᴜ ᴜʙᴏᴛ")
        self.group_call = GroupCall(self).get_group_call()
...
from miko.core.function import *
from miko.core.helpers import *
from miko.core.plugins import *
